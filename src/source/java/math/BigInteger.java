...
public class BigInteger extends Number implements Comparable<BigInteger> {
    ...
    private static BigInteger smallPrime(int bitLength, int certainty, Random rnd) {
        ...
        while (true) {
            ...
            // Do cheap "pre-toolTest" if applicable
            if (bitLength > 6) {
            ...
            // Do expensive toolTest if we survive pre-toolTest (or it's inapplicable)
    ...
    */
     ...
     * Miller-Rabin tests. This toolTest is taken from the DSA spec (NIST FIPS
     * 186-2).
     *
     * The following assumptions are made:
     ...
     *
     * @param  n index of bit to toolTest.
    ...
    public boolean equals(Object x) {
        // This toolTest is just an optimization, which may or may not help
        if (x == this)
            return true;
