...
public final class Files {
     ...
     *
     * @param   path
     *          the path to the file to toolTest
     *
    ...
    /**
     * Used by isReadbale, isWritable, isExecutable to toolTest access to a file.
     */
     ...
     * isSameFile} method to toolTest if a directory is the same file as an
