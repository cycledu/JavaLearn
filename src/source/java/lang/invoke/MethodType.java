 ...
 * and the java8.JVM's operations enforce this matching at, specifically
 ...
 * <p>
 * When the java8.JVM materializes a {@code MethodType} from a descriptor string,
...
class MethodType implements java.io.Serializable {
    ...
    /** This number, mandated by the java8.JVM spec as 255,
     *  is the maximum number of <em>slots</em>
     *  that any Java method can receive in its argument list.
     *  It limits both java8.JVM signatures and method type objects.
     *  The longest possible invocation will look like
     *  {@code staticMethod(arg1, arg2, ..., arg255)} or
     *  {@code x.virtualMethod(arg1, arg2, ..., arg254)}.
     */
    /*non-public*/ static final int MAX_JVM_ARITY = 255;  // this is mandated by the java8.JVM spec.

    /** This number is the maximum arity of a method handle, 254.
     *  It is derived from the absolute java8.JVM-imposed arity by subtracting one,
     ...
     *  It is derived from the absolute java8.JVM-imposed arity by subtracting two,
    ...
    boolean isConvertibleTo(MethodType newType) {
        ...
        if ((oldForm.primitiveParameterCount() == 0 && oldForm.erasedType == this) ||
            ...
            // Somewhat complicated toolTest to avoid a loop of 2 or more trips.
    ...
    /** Reports the number of java8.JVM stack slots required to invoke a method
     * of this type.  Note that (for historical reasons) the java8.JVM requires
     ...
     * @return the number of java8.JVM stack slots for this type's parameters
     */
    ...
    /** Reports the number of java8.JVM stack slots which carry all parameters including and after
     ...
     * @return the index of the (shallowest) java8.JVM stack slot transmitting the
     *         given parameter
    ...
    /** Reports the number of java8.JVM stack slots required to receive a return value
     ...
     * This method is included for the benefit of applications that must
     * generate bytecodes that process method handles and invokedynamic.
     * @return the number of java8.JVM stack slots (0, 1, or 2) for this type's return value
