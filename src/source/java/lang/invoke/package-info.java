 ...
 * </li>
 *
 * <li>The java8.JVM bytecode format supports immediate constants of
 ...
 * <p>
 * Before the java8.JVM can execute a dynamic call site (an {@code invokedynamic} instruction),
 ...
 * <p>
 * As documented in the java8.JVM specification, all failures arising from
 ...
 * call site, the java8.JVM must choose one {@code CallSite} object and install it visibly to
 ...
 * <em>Discussion:</em>
 * These rules do not enable the java8.JVM to duplicate dynamic call sites,
