...
/**
 * The java8.JVM interface for the method handles package is all here.
...
class MethodHandleNatives {
    ...
    /** Fetch MH-related java8.JVM parameter.
    ...
    /** Tell the java8.JVM that we need to change the target of a CallSite. */
    ...
    static {
        ...
        // The java8.JVM calls MethodHandleNatives.<clinit>.  Cascade the <clinit> calls as needed:
        MethodHandleImpl.initStatics();
    }

    // All compile-time constants go here.
    // There is an opportunity to check them against the java8.JVM's idea of them.
    static class Constants {
        ...
        // MemberName
        // The java8.JVM uses values of -2 and above for vtable indexes.
        ...
        /**
         * Basic types as encoded in the java8.JVM.  These code values are not
         * intended for use outside this class.  They are used as part of
         * a private interface between the java8.JVM and this class.
         */
        static final int
            T_BOOLEAN  =  4,
            T_CHAR     =  5,
    ...
    static boolean verifyConstants() {
        ...
        for (int i = 0; ; i++) {
            ...
            try {
                ...
                String err = (name+": java8.JVM has "+vmval+" while Java has "+jval);
                ...
                String err = (name+": java8.JVM has "+vmval+" which Java does not define");
                // ignore exotic ops the java8.JVM cares about; we just wont issue them
                //System.err.println("warning: "+err);
                continue;
            }
        }
    ...
    // Up-calls from the java8.JVM.
    // These must NOT be public.

    /**
     * The java8.JVM is linking an invokedynamic instruction.  Create a reified call site for it.
     */
    ...
    /**
     * The java8.JVM wants a pointer to a MethodType.  Oblige it by finding or creating one.
     */
    ...
    /**
     * The java8.JVM wants to link a call site that requires a dynamic type check.
     * Name is a type-checking invoker, invokeExact or invoke.
     * Return a java8.JVM method (MemberName) to handle the invoking.
     ...
     * <p>
     * The java8.JVM is allowed to reify this method as instance metadata.
     * For example, {@code invokeBasic} is always reified.
     * But the java8.JVM may instead call {@code linkMethod}.
     ...
     * <p>
     * The java8.JVM does not inspect the appendix, other than to pass
     ...
     * <p>
     * If the java8.JVM does not reify a method at a call site, but instead
    ...
    /**
     * The java8.JVM is resolving a CONSTANT_MethodHandle CP entry.  And it wants our help.
     * It will make an up-call to this method.  (Do not change the name or signature.)
     * The type argument is a Class for field requests and a MethodType for non-fields.
     * <p>
     * Recent versions of the java8.JVM may also pass a resolved MemberName for the type.
