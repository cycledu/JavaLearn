...
<blockquote><pre>{@code
static void toolTest() throws Throwable {
    // THE FOLLOWING LINE IS PSEUDOCODE FOR A java8.JVM INSTRUCTION
...
public class CallSite {
    ...
    /*package-private*/
    MethodHandle target;    // Note: This field is known to the java8.JVM.  Do not change.
    ...
    // this implements the upcall from the java8.JVM, MethodHandleNatives.makeDynamicCallSite:
