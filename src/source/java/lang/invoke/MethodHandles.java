 ...
 * <li>Other factory methods to create method handles that emulate other common java8.JVM operations or control flow patterns.
 * </ul>
 * <p>
...
public class MethodHandles {
     ...
     * supplied by the java8.JVM to the bootstrap method of an
     ...
     * Where the java8.JVM would raise exceptions like {@code NoSuchMethodError},
     ...
     * <p>
     * If the desired member is {@code protected}, the usual java8.JVM rules apply,
     ...
     * <p>
     * The java8.JVM imposes a similar requirement on {@code invokespecial} instruction,
     * that the receiver argument must match both the resolved method <em>and</em>
     * the current class.  Again, this requirement is enforced by narrowing the
     * type of the leading parameter to the resulting method handle.
     * (See the Java Virtual Machine Specification, section 4.10.1.9.)
     * <p>
     * The java8.JVM represents constructors and static initializer blocks as internal methods
     * with special names ({@code "<init>"} and {@code "<clinit>"}).
     * The internal syntax of invocation instructions allows them to refer to such internal
     * methods as if they were normal methods, but the java8.JVM bytecode verifier rejects them.
...
assertEquals("", (String) MH_newString.invokeExact());
         ...
         * (This is consistent with the java8.JVM's treatment of constructor type descriptors.)
         * <p>
         * The returned method handle will have
         * {@linkplain MethodHandle#asVarargsCollector variable arity} if and only if
...
assertEquals("[x, y, z]", pb.command().toString());
         ...
         * the method's variable arity modifier bit ({@code 0x0080}) is set.
         * <p style="font-size:smaller;">
         * <em>(Note:  java8.JVM internal methods named {@code "<init>"} are not visible to this API,
...
return mh1;
        ...
        void checkAccess(byte refKind, Class<?> refc, MemberName m) throws IllegalAccessException {
            ...
            if (Modifier.isProtected(mods) &&
                    ...
                    refc.isArray()) {
                // The java8.JVM does this hack also.
                // (See ClassVerifier::verify_invoke_instructions
                // and LinkResolver::check_method_accessability.)
                // Because the java8.JVM does not allow separate methods on array types,
        ...
        /** Hook called from the java8.JVM (via MethodHandleNatives) to link MH constants:
         */
        /*non-public*/
...
assertEquals("boojum", (String) catTrace.invokeExact("boo", "jum"));
     ...
     * by guarding it with a toolTest, a boolean-valued method handle.
     * If the guard fails, a fallback handle is called instead.
     * All three method handles must have the same corresponding
     * argument and return types, except that the return type
     * of the toolTest must be boolean, and the toolTest is allowed
     ...
     * }
     * }</pre></blockquote>
     * Note that the toolTest arguments ({@code a...} in the pseudocode) cannot
     * be modified by execution of the toolTest, and so are passed unchanged
     * from the caller to the target or fallback as appropriate.
     * @param test method handle used for toolTest, must return boolean
     * @param target method handle to call if toolTest passes
     * @param fallback method handle to call if toolTest fails
     * @return method handle which incorporates the specified if/then/else logic
     * @throws NullPointerException if any argument is null
     * @throws IllegalArgumentException if {@code toolTest} does not return boolean,
     *          or if all three method types do not match (with the return
     *          type of {@code toolTest} changed to match that of the target).
     */
    public static
    MethodHandle guardWithTest(MethodHandle test,
        ...
        if (!targs.equals(gargs)) {
            ...
            if (gpc >= tpc || !targs.subList(0, gpc).equals(gargs))
                throw misMatchedTypes("target and toolTest types", ttype, gtype);
