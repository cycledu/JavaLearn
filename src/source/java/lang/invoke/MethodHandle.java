 ...
 * which connects this freedom of invocation directly to the java8.JVM execution stack.
 * <p>
 ...
 * the receiving method handle's type is first checked by the java8.JVM
 ...
 * But if a match fails, the java8.JVM will throw a {@link WrongMethodTypeException},
 ...
 * can throw.  Since the java8.JVM does not distinguish between checked
 ...
 * <p>
 * When the java8.JVM processes bytecode containing signature polymorphic calls,
 * it will successfully link any such call, regardless of its symbolic type descriptor.
 * (In order to retain type safety, the java8.JVM will guard such calls with suitable
 ...
 * The java8.JVM imposes on all methods and constructors of any kind an absolute
 ...
 * </ul>
 * These limits imply that certain method handles cannot be created, solely because of the java8.JVM limit on stacked arguments.
 * For example, if a static java8.JVM method accepts exactly 255 arguments, a method handle cannot be created for it.
...
public abstract class MethodHandle {
     ...
     * If the java8.JVM can predict the results of making the call, it may perform
     ...
     * Type mismatches will not throw {@code WrongMethodTypeException}, but could crash the java8.JVM.
     * <p>
     ...
     * although the methods are not guaranteed to be called if the java8.JVM
