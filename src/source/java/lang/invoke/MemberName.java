 ...
 * <p>
 * When resolved, a member name's internal implementation may include references to java8.JVM metadata.
...
/*non-public*/ final class MemberName implements Member, Cloneable {
    ...
    // modifiers exported by the java8.JVM:
    ...
    public MemberName(Method m, boolean wantSpecial) {
        ...
        if (clazz == null) {  // MHN.init failed
            if (m.getDeclaringClass() == MethodHandle.class &&
                ...
                // The java8.JVM did not reify this signature-polymorphic instance.
     ...
     *  (Note that resolving in the java8.JVM will sometimes devirtualize, changing
     ...
     * (of MH.invokeExact, etc.) that the java8.JVM does not reify.
    ...
    // bare-bones constructor; the java8.JVM will fill it in
    MemberName() { }
     ...
     *  A resolved member name is one for which the java8.JVM has found
    ...
    /*non-public*/ static class Factory {
        ...
        List<MemberName> getMembers(Class<?> defc,
            ...
            for (;;) {
                ...
                // java8.JVM returned to us with an intentional overflow!
        ...
        private MemberName resolve(byte refKind, MemberName ref, Class<?> lookupClass) {
            MemberName m = ref.clone();  // java8.JVM will side-effect the ref
            ...
            try {
                ...
                // We do type alias (TA) checks on DEFC to ensure that. DEFC is not known until the java8.JVM
                ...
                // java8.JVM reports that the "bytecode behavior" would get an error
                assert(!m.isResolved());
                m.resolution = ex;
                return m;
            }
        ...
        private static MemberName[] newMemberBuffer(int length) {
            ...
            // fill the buffer with dummy structs for the java8.JVM to fill in
