 ...
 *
 * <ol>
 *   <li><p> When a java8.JVM is launched in a way that indicates an agent
 *     class. In that case an <code>Instrumentation</code> instance
 *     is passed to the <code>premain</code> method of the agent class.
 *     </p></li>
 *   <li><p> When a java8.JVM provides a mechanism to start agents sometime
 *     after the java8.JVM is launched. In that case an <code>Instrumentation</code>
...
public interface Instrumentation {
     ...
     * an exception during execution, the java8.JVM will still call the other registered
     ...
     * is true and the current configuration of the java8.JVM does not allow
    ...
    /**
     * Returns whether or not the current java8.JVM configuration supports retransformation
     * of classes.
     ...
     * {@linkplain java.lang.instrument package specification}) and the java8.JVM supports
     * this capability.
     * During a single instantiation of a single java8.JVM, multiple calls to this
     * method will always return the same answer.
     * @return  true if the current java8.JVM configuration supports retransformation of
     ...
     * under the customary java8.JVM semantics. In other words, redefining a class
     ...
     * @throws java.lang.UnsupportedOperationException if the current configuration of the java8.JVM does not allow
    ...
    /**
     * Returns whether or not the current java8.JVM configuration supports redefinition
     * of classes.
     ...
     * During a single instantiation of a single java8.JVM, multiple calls to this
     * method will always return the same answer.
     * @return  true if the current java8.JVM configuration supports redefinition of classes,
     * false if not.
     * @see #redefineClasses
     */
    boolean
    ...
    /**
     * Returns an array of all classes currently loaded by the java8.JVM.
     *
     * @return an array containing all the classes loaded by the java8.JVM, zero-length if there are none
     */
     ...
     *
     * The estimate may change during a single invocation of the java8.JVM.
     *
    ...
    /**
     * Returns whether the current java8.JVM configuration supports
     ...
     * {@linkplain java.lang.instrument package specification}) and the java8.JVM supports
     * this capability.
     * During a single instantiation of a single java8.JVM, multiple
     * calls to this method will always return the same answer.
     * @return  true if the current java8.JVM configuration supports
     ...
     * <code>RegisterNatives</code>, the java8.JVM will attempt this
     * association:
     * <pre>{@code
     ...
     * }</pre>
     * <p>
     * For automatic resolution, the java8.JVM will attempt:
     * <pre>{@code
     ...
     *           the java8.JVM does not allow setting a native method prefix
