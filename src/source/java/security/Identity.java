...
public abstract class Identity implements Principal, Serializable {
     ...
     * override.
     *
     * @param identity the object to toolTest for equality with this identity.
     *
     ...
     * This method should be overriden by subclasses to toolTest for equality.
     * The default behavior is to return true if the names and public keys
     * are equal.
     *
     * @param identity the identity to toolTest for equality with this identity.
     *
