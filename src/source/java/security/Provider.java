...
public abstract class Provider extends Properties {
    ...
    public static class Service {
         ...
         * true if this service can use the parameter, if a fast toolTest is
         ...
         * Java Cryptography Architecture API Specification &amp;
         * Reference</a>.
         * Security providers can override it to implement their own toolTest.
         *
         * @param parameter the parameter to toolTest
         *
