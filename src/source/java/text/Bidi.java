...
public final class Bidi {
     ...
     *
     * @param text the text containing the characters to toolTest
     * @param start the start of the range of characters to toolTest
     * @param limit the limit of the range of characters to toolTest
