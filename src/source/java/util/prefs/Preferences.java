 ...
 * in a single java8.JVM without the need for external synchronization, and the
...
public abstract class Preferences {
     ...
     * used to toolTest whether <tt>p</tt> has been removed.
     *
     ...
     * method.)
     *
     * <p>Events are only guaranteed for changes made within the same java8.JVM
     * as the registered listener, though some implementations may generate
     * events for changes made outside this java8.JVM.  Events may be generated
