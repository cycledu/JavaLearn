 ...
 *        FileOutputStream fos = new FileOutputStream("/tmp/toolTest.pack");
 *        // Call the packer
 *        packer.pack(jarFile, fos);
 *        jarFile.close();
 *        fos.close();
 *
 *        File f = new File("/tmp/toolTest.pack");
 *        FileOutputStream fostream = new FileOutputStream("/tmp/toolTest.jar");
