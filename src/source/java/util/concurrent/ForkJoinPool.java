...
public class ForkJoinPool extends AbstractExecutorService {
     ...
     * other java8.JVM or OS activities that are made worse by replacement.
     ...
     * resources are reclaimed by the java8.JVM and OS. So the number of
     ...
     * be java8.JVM-dependent and must access particular Thread class fields
